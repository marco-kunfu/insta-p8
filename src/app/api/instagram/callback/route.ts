...
// Instagram redirects here after Business Login. Land on /instagram-return,
// the mode-aware return page: `state` carries the panel mode and vendorId
// across the top-level hop (sessionStorage does not survive it), and that
// page decides whether to notify the iframe and close (embed) or continue in
// this same tab towards /dashboard (standalone).
export async function GET(request: NextRequest) {
  ...
  if (error) {
    const redirectUrl = new URL("/instagram-return", request.url)
